...
const SVG = {
  MapPin: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none">
      <path d="M12 21s6-5.433 6-10A6 6 0 0 0 6 11c0 4.567 6 10 6 10z" stroke="currentColor" stroke-width="1.4"></path>
      <circle cx="12" cy="11" r="2.5" fill="currentColor"></circle></svg>`,

  Phone: `<svg viewBox="0 0 24 24" width="20" height="20" fill="none">
      <path d="M22 16.92v2.3a1.8 1.8 0 0 1-1.96 1.8A18.2 18.2 0 0 1 3 3.96 1.8 1.8 0 0 1 4.8 2h2.3a1.8 1.8 0 0 1 1.75 1.45l.38 2a1.8 1.8 0 0 1-.51 1.62l-1.3 1.3a14.5 14.5 0 0 0 8.2 8.2l1.3-1.3a1.8 1.8 0 0 1 1.62-.51l2 .38A1.8 1.8 0 0 1 22 16.92z"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,

  Mail: `<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        <path d="M3 6.75A1.75 1.75 0 0 1 4.75 5h14.5A1.75 1.75 0 0 1 21 6.75v10.5A1.75 1.75 0 0 1 19.25 19H4.75A1.75 1.75 0 0 1 3 17.25V6.75zm1.8.25L12 12.1 19.2 7H4.8zm14.7 1.72-6.92 4.9a1 1 0 0 1-1.16 0L4.5 8.72v8.53c0 .14.11.25.25.25h14.5a.25.25 0 0 0 .25-.25V8.72z"/>
        </svg>`,

  Clock: `<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
          <circle cx="12" cy="12" r="10"></circle>
          <path d="M12 6v6l4 2" fill="white"></path>
          </svg>`,
